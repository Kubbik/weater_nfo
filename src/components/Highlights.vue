        ...
        <div class="card-small-info">
          ...
          <div class="card-small-hint">
            ...
            <div class="card-small-text text-egorova">
              Узнайте
              <!--<a href="https://www.windy.com/articles/weather-phenomena-what-s-the-difference-between-sustained-winds-and-wind-gusts-10390?satellite,55.659,92.873,8"
                target="_blank">--> <a href="https://www.windy.com/56.009/92.873?satellite,55.661,92.873,8" target="_blank">больше</a>
              о порыве ветра
            </div>
          </div>
        </div>
