                ...
                <div class="block-bottom-texts">
                    <div class="block-bottom-text-block">
                        ...
                        <div class="block-bottom-text-block-desc">
                            ...
                            Водяной пар, газообразное состояние воды, как правило, невидим для человеческого глаза.
                            <br /><br />
                            Одинаковое количество водяного пара приводит к более высокой относительной влажности холодного воздуха, чем теплого.
                            Связанным параметром является точка росы.
                        </div>
                    </div>
                </div>
            </div>
